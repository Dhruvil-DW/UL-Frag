  ...
  return (
    <>
      ...
      <div className="questionContainer fixWidth" style={{ flexGrow: 0 }}>
        ...
        <TextField multiline rows={8} inputProps={{ maxLength: 100 }} variant="outlined" color="secondary" placeholder="Enter your answer here" value={input} onChange={(e) => setInput(e.target.value)} />
