...
const questions = [
  ...
  {category_id:1, question:"Select business unit", question_type_id:4, status:1, parent_id: 0},
  {category_id:1, question:"Select country", question_type_id:6, status:1, parent_id: 0},
  {category_id:1, question:"Markets for the project", question_type_id:12, status:1, parent_id: 0},
  {category_id:1, question:"Lead markets", question_type_id:0, status:1, parent_id: 6},
  {category_id:1, question:"Rollout markets", question_type_id:0, status:1, parent_id: 6},
  {category_id:1, question:"Impacted markets", question_type_id:0, status:1, parent_id: 6},
