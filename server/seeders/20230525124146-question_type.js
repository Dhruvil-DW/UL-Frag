...
const question_type = [
  ...
  {id: 10, question_type: "Single Choice predefined Radio button", description:"Radio button, simple MCQ type question with predefined options"},
  {id: 11, question_type: "Checkbox with predefined option", description:"Checkbox with predefined option"},
