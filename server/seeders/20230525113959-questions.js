...
const questions = [
  ...
  { category_id: 3, question: "Select the moments where you would expect the fragrance to do its best", question_opt: '["Pre-wash", "During wash", "After wash (wet)", "After wash (dry)"]', question_type_id: 8, status: 1, parent_id: 0 },
